"""
=============================================================================
train_model1_same_emotion.py
=============================================================================
Model 1 — INDEPENDENT TRAINING
Dataset : same_emotion.csv  (38,862 pairs)
Base    : roberta-base  (fresh — no dependency on any other model)
Output  : /kaggle/working/model_same_emotion/

What this dataset contains:
  - Previous and current message have the SAME emotion
  - Example: previous="I am so happy!", current="This is the best day!"
  - Emotion label = current message emotion
  - Teaches model: emotion consistency in context
=============================================================================
"""
...
OUTPUT_DIR = "/kaggle/working/model_same_emotion"
...
print("=" * 55)
print("  MODEL 1 — same_emotion.csv")
...
print(f"\n{'='*55}")
print(f"  ✅ MODEL 1 COMPLETE — same_emotion")
